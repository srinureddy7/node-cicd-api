...
const transporter = nodemailer_1.default.createTransport({
    service: "gmail",
    auth: {
        user: (0, env_config_1.default)().AppServiceEmail,
        pass: (0, env_config_1.default)().AppServiceEmailPassword,
    },
});
  ...
  <body>
      <div style="width: 100%;max-width:720px;margin:auto; background-color: rgb(238,238,238);">
          <table style="width: 100%; ">
              <tr style="
                  ...
                  <td style="width: 100%; padding: 1rem;text-align:start">
                      ...
                      <img src="${(0, env_config_1.default)().APP_LOGO}" alt="${(0, env_config_1.default)().APP_NAME}"
                  ...
                  <td style="
                      ...
                      <div class="button-warper">
                          <a href="${(0, env_config_1.default)().APP_WEBSITE_ENDPOINT}" target="_blank" style="
                              padding: 0.7rem 3rem;
              ...
              <tr style="width:100%;">
                  <td colspan="2"
                      ...
                      <div>
                          <a href="${(0, env_config_1.default)().APP_TWITTER_URL}" target="_blank" style="height: 100% ; width: 100%;">
                          ...
                          <a href="${(0, env_config_1.default)().APP_LINKEDIN_URL}" target="_blank" style="text-decoration: none; margin: .2rem;   ">
                          ...
                          <a href="${(0, env_config_1.default)().APP_FACEBOOK_URL}" target="_blank" style="text-decoration: none; margin: .2rem ">
                          ...
                          <a href="${(0, env_config_1.default)().APP_INSTAGRAM_URL}" target="_blank" style="text-decoration: none; margin: .2rem; ">
                      ...
                      <h3 style="text-align: center; padding: 1rem;">${(0, env_config_1.default)().APP_PHONE_NUMBER}</h3>
                      <p>Copyright © 2022 ${(0, env_config_1.default)().APP_NAME}</p>
                  </td>
              </tr>
          ...
          <div style="width: 100%; text-align: center; padding: 2rem;">
              <p style="color: rgb(113, 113, 113) ;">${(0, env_config_1.default)().APP_NAME}</p>
              <p style="color: rgb(113, 113, 113) ;">${(0, env_config_1.default)().APP_ADDRESS}</p>
          </div>
          <div style="width: 100%; text-align: center; padding: 2rem;">
              <p style="color: rgb(113, 113, 113) ; font-size: 12px;">You're receiving this email because you
                  signed up for a ${(0, env_config_1.default)().APP_NAME}
                  account.</p>
          </div>
      </div>
  </body>
...
function sendEmail({ to, subject, text, }) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            try {
                const mailOptions = {
                    from: (0, env_config_1.default)().APP_EMAIL,
                    to,
                    subject,
